...
(function(exports) {
  ...
  var getFeed = Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)(CuriPodcastProxy_Const.podcastURL))(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("Got back: " + v.response))(function () {
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v.response);
      });
  });
  var serve = (function () {
      var proxy = Control_Bind.discard(Control_Bind.discardUnit)(QuickServe.bindMethod)(Control_Monad_Aff_Class.liftAff(QuickServe.monadAffMethod)(Control_Monad_Aff_Console.log("Got request for feed")))(function () {
          return Control_Bind.bind(QuickServe.bindMethod)(Control_Monad_Aff_Class.liftAff(QuickServe.monadAffMethod)(getFeed))(function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(QuickServe.bindMethod)(Control_Monad_Aff_Class.liftAff(QuickServe.monadAffMethod)(Control_Monad_Aff_Console.log("Got feed: " + v)))(function () {
